...
function updateThemeLabel() {
  ...
  themeLabel.textContent = document.body.classList.contains("light-theme") ? "Light mode" : "Dark mode";
}
  ...
  return `
    <aside class="sidebar">
      ...
      <div class="sidebar-footer">
        <button class="button button-ghost button-small" data-theme-toggle>
          Theme: <span data-theme-label>Dark mode</span>
        </button>
        <div>
